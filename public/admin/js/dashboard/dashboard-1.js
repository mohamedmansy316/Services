(function ($) {
    ...
    var dzChartlist = (function () {
        ...
        const TotalAvailable = $("#productsChart").data("available");
        const TotalSold = $("#productsChart").data("sold");
        const TotalHidden = $("#productsChart").data("hidden");
        var donutChart = function () {
            var options = {
                series: [TotalAvailable, TotalHidden, TotalSold],
                chart: {
                    type: "donut",
                },
                legend: {
                ...
                tooltip: {
                    ...
                    custom: function ({ series, seriesIndex, dataPointIndex }) {
                        const Labels = ["Available", "Hidden", "Sold Out"];
                        const Data = [TotalAvailable, TotalHidden, TotalSold];
                        return (
        ...
        var revenueChart = function () {
            ...
            if (revenue !== null) {
                        ...
                        datasets: [
                            {
                                ...
                                data: [
                                    35, 40, 30, 38, 32, 42, 30, 35, 22, 30, 45,
                                    30,
                                ],
                ...
                var items = document.querySelectorAll(
                    "#sales-revenue .nav-tabs .nav-item"
                );
                items.forEach(function (item, index) {
                    item.addEventListener("click", function () {
                        config.data.datasets[0].data =
                            activityData[index].first;
                        myLine.update();
                    });
                });
            }
        ...
        var chartBar = function () {
            if (jQuery("#chart_widget_2").length > 0) {
                const chart_widget_2 = document
                    ...
                    .getContext("2d");
                //generate gradient
                const chart_widget_2gradientStroke =
                    chart_widget_2.createLinearGradient(250, 0, 0, 0);
